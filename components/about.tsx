        ...
        >
            ...
            <div className="mb-3 sm:mx-2 mx-6 sm:text-center text-justify">
                <p>
                    ...
                    <br />
                    My adventures include building <span className="italic">Full Stack Paytm Payment application</span> and designing Payment gateway for merchant app and Devloping Own blogging Platform performing CRUD operations <span className="font-medium"></span>. From working on Nuro An AI driven chatbot to leading development teams. I thrive in projects where I can bring creativity and cutting-edge technology together.
                    <br />
